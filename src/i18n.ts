...
export const ENGLISH_TRANSLATIONS = {
  ...
  "settings.ocrHeading.name": "OCR",
  "settings.ocrApiUrl.name": "OCR API URL",
  "settings.ocrApiUrl.desc": "Chat completions endpoint used for OCR. Leave empty to reuse the main API URL.",
  "settings.ocrApiKey.name": "OCR API key",
  "settings.ocrApiKey.desc": "Leave empty to reuse the main API key.",
  "settings.ocrModel.name": "OCR model",
  "settings.ocrModel.desc": "Vision-capable model used for OCR. Leave empty to reuse the main model.",
  "settings.ocrTimeout.name": "OCR request timeout (seconds)",
  "settings.ocrTimeout.desc": "Overrides the main request timeout for OCR calls. 0 reuses the main timeout.",
  "settings.ocrConcurrency.name": "OCR concurrency",
  "settings.ocrConcurrency.desc": "Maximum number of OCR requests in flight at once. Higher values ingest vision-heavy sources faster but increase API pressure.",
  "settings.testOcrConnection.name": "Test OCR connection",
  "settings.testOcrConnection.desc": "Checks whether the OCR endpoint returns HTTP 2xx.",
  ...
  "command.ingestActiveSource": "Ingest changed raw files into Auto LLM Wiki",
  "command.queryWiki": "Query Auto LLM Wiki",
  "command.lintWiki": "Lint Auto LLM Wiki",
  "command.openChat": "Open Auto LLM Wiki chat",
  "chat.viewTitle": "Auto LLM Wiki chat",
  ...
  "notice.rawScanFailed": "Auto LLM Wiki: skipped unreadable raw files — {details}",
  "status.readingVaultContext": "Auto LLM Wiki: reading vault context...",
  "status.selectingPages": "Auto LLM Wiki: selecting relevant wiki pages...",
...
const ZH_TRANSLATIONS: Partial<TranslationTable> = {
  ...
  "settings.ocrHeading.name": "OCR",
  "settings.ocrApiUrl.name": "OCR API URL",
  "settings.ocrApiUrl.desc": "用于 OCR 的聊天补全端点。留空则复用主 API URL。",
  "settings.ocrApiKey.name": "OCR API 密钥",
  "settings.ocrApiKey.desc": "留空则复用主 API 密钥。",
  "settings.ocrModel.name": "OCR 模型",
  "settings.ocrModel.desc": "用于 OCR 的视觉模型。留空则复用主模型。",
  "settings.ocrTimeout.name": "OCR 请求超时（秒）",
  "settings.ocrTimeout.desc": "覆盖 OCR 调用的主请求超时。设为 0 表示复用主超时。",
  "settings.ocrConcurrency.name": "OCR 并发数",
  "settings.ocrConcurrency.desc": "同时进行的 OCR 请求上限。数值越大，摄入含视觉内容的源文件越快，但 API 压力也越高。",
  "settings.testOcrConnection.name": "测试 OCR 连接",
  "settings.testOcrConnection.desc": "检查 OCR 端点是否返回 HTTP 2xx。",
  ...
  "command.ingestActiveSource": "将变更的原始文件导入 Auto LLM Wiki",
  "command.queryWiki": "查询 Auto LLM Wiki",
  "command.lintWiki": "检查 Auto LLM Wiki",
  "command.openChat": "打开 Auto LLM Wiki 对话",
  "chat.viewTitle": "Auto LLM Wiki 对话",
  ...
  "notice.rawScanFailed": "Auto LLM Wiki：已跳过无法读取的原始文件——{details}",
  "status.readingVaultContext": "Auto LLM Wiki：正在读取库上下文...",
  "status.selectingPages": "Auto LLM Wiki：正在挑选相关 Wiki 页面...",
